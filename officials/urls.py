...
urlpatterns = [
    ...
    path('<int:pk>/enrollment/sync-progress/', views.sync_scan_progress, name='sync_scan_progress'),
    path('<int:pk>/enrollment/register/', views.register_fingerprint_after_scans, name='register_fingerprint'),
    path('<int:pk>/enrollment/remove/', views.remove_fingerprint, name='remove_fingerprint'),
